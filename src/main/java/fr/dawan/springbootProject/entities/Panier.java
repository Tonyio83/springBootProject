package fr.dawan.springbootProject.entities;
...
import fr.dawan.springbootProject.enums.EtatPanier;
...
public class Panier implements Serializable {
	...
	public Panier(Utilisateur user, List<VenteArticle> idVentePanier, int quantite, double total,
			fr.dawan.springbootProject.enums.EtatPanier etatPanier, LocalDate dateValidation) {
		super();
		this.user = user;
