		...
		<c:url value="/admin/addArticle" context="/springbootProject" var="urlform"/>
			<form:form method="post" action="${urlform}" modelAttribute="formArticle" class="col-md-5 p-5 shadow-sm mb-5 bg-body rounded mx-auto">
				...
				<div class="mb-3">
					...
					<form:input path="" type="text" class="form-control" id="inputName"/>
				</div>
				<div class="mb-3">
					<form:label path="" for="inputDescription" class="form-label">Description</form:label> 
					<form:input path="" type="text" class="form-control" id="inputDescription"/>
				</div>
				<div class="mb-3">
					<form:label path="" for="inputPrice" class="form-label">Prix</form:label> 
					<form:input path="" type="number" class="form-control" id="inputPrice"/>
				</div>
				<div class="mb-3">
					<form:label path="" for="inputImage" class="form-label">Image</form:label> 
					<form:input path="" type="file" class="form-control" id="inputImage"/>
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<form:input path="" type="text" class="form-control" id="inputMarque"/>
				</div>
				<div class="mb-3">
					<form:label path="" for="inputQuantity" class="form-label">Quantité</form:label> 
					<form:input path="" type="number" class="form-control" id="inputQuantity"/>
				</div>
