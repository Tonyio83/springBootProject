...
<body>
	<main>
		<div class="container my-5">
			<form class="col-md-5 p-5 shadow-sm mb-5 bg-body rounded mx-auto">
				...
				<div class="mb-3">
					...
					<input type="email" class="form-control" id="inputEmail" placeholder="Entrez votre adresse mail">
				</div>
				<div class="mb-3">
					<label for="inputBirthDate" class="form-label">Date de naissance</label> 
					<input type="date" class="form-control" id="inputBirthDate" placeholder="Entrez votre date de naissance">
				</div>
				<div class="mb-3">
					<label for="inputAddress" class="form-label">Adresse</label> 
					<input type="text" class="form-control" id="inputAddress" placeholder="Entrez votre adresse">
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					<label for="inputConfirmPassword" class="form-label">Confirmez mot de passe</label>
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="inputBirthDate" placeholder="Entrez votre numéro de téléphone">
				</div>
